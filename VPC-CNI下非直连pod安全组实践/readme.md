...
# 快速开始
本次操作以nginx服务为例<br>
service四层端口：服务端口80,主机端口31000,外网访问端口80)<br>
ingress七层端口：服务端口80,主机端口31000,外网访问端口80)<br>
## 安全组配置
service四层安全组配置：<br>
节点安全组配置：允许所有来源的TCP 31000端口入站流量，并开放所有出站流量。<br>
pod(辅助)网卡安全组配置:允许所有来源的TCP:80端口入站流量，并开放所有出站流量。<br>
clb安全组配置:允许所有来源的TCP:80端口入站流量，并开放所有出站流量。<br>
ingress七层安全组配置：<br>
节点安全组配置：允许所有来源的TCP 31000端口入站流量，并开放所有出站流量。<br>
pod(辅助)网卡安全组配置:允许所有来源的TCP:80端口入站流量，并开放所有出站流量。<br>
clb安全组配置:允许所有来源的TCP:80端口入站流量，并开放所有出站流量。<br>
